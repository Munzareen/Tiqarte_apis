namespace WebAPI.Migrations
{
    ...
    public partial class UpdateDb117 : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.ShopCheckOuts", "PaymentStatus", c => c.String());
            AlterStoredProcedure(
                ...
                body:
                    @"INSERT [dbo].[ShopCheckOuts]([UserId], [CustomerName], [CustomerEmail], [State], [City], [PostalCode], [MobileNumber], [PurchaseDate], [OrderNo], [PromotorId], [isHide], [isActive], [BillingCountry], [AddressLine1], [AddressLine2], [isRefund], [RefundTime], [PaymentStatus])
                      VALUES (@UserId, @CustomerName, @CustomerEmail, @State, @City, @PostalCode, @MobileNumber, @PurchaseDate, @OrderNo, @PromotorId, @isHide, @isActive, @BillingCountry, @AddressLine1, @AddressLine2, @isRefund, @RefundTime, @PaymentStatus)
        ...
        {
            DropColumn("dbo.ShopCheckOuts", "PaymentStatus");
